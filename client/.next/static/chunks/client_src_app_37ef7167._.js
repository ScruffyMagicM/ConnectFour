...
const useLobbySocket = (socket, callbacks)=>{
    ...
    const createGame = (name)=>{
        socket === null || socket === void 0 ? void 0 : socket.emit('createGame', {
            name
        });
    };
    const joinGame = (roomId, playerId)=>{
        socket === null || socket === void 0 ? void 0 : socket.emit('joinGame', {
            roomId: roomId,
            playerId: playerId
        });
    };
    const quitGame = (roomId, playerId)=>{
        socket === null || socket === void 0 ? void 0 : socket.emit('quitGame', {
            roomId,
            playerId
        });
    };
...
function Lobby(param) {
    let { enterGame, setMessage, socket } = param;
    _s();
...
_s(Lobby, "wPPR2WSbUhJbrvlLw+Rrh6ex2UE=", false, function() {
    return [
...
function Board(param) {
    let { gameId, playerId, setMessage, leaveGame, socket } = param;
    _s();
...
_s(Board, "iiQrx8IW2/Z24NEFJf3x5X6gR1g=", false, function() {
    return [
...
const useSocketConnection = ()=>{
    _s();
    const [socket, setSocket] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [isConnected, setIsConnected] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useSocketConnection.useEffect": ()=>{
            const newSocket = (0, __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$node_modules$2f$socket$2e$io$2d$client$2f$build$2f$esm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["io"])('http://localhost:3001');
            setSocket(newSocket);
...
_s(useSocketConnection, "QMiDLkz4HTcH977k6GWSjZyAdcs=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
function ConnectFour() {
    ...
    const { socket, isConnected } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$src$2f$app$2f$hooks$2f$useSocketConnection$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSocketConnection"])();
...
_s(ConnectFour, "wsfC9QRR18NXnnK8fS8sDYQgXEM=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$src$2f$app$2f$hooks$2f$useAppState$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppState"],
...
//# sourceMappingURL=client_src_app_37ef7167._.js.map